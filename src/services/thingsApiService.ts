 ...
 * @returns
 */
const createThing = async (td: ThingDescription, targetUrl: string): Promise<number> => {
 ...
 * @returns
 */
const createAnonymousThing = async (td: ThingDescription, targetUrl: string): Promise<number> => {
